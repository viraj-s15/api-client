  ...
  return (
    <Show when={props.show}>
      <div class="fixed z-50 top-0 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.75)]">
        <div class="relative flex flex-col items-center justify-center max-h-[85%] overflow-y-auto top-20 bg-gray-200 max-w-md m-auto p-8 pb-8 border-t-4 border-blue-600 rounded-sm shadow-xl">
